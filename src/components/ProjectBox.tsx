...
export const ProjectBox: React.FC<ProjectItemProps> = (props) => {
    return (
    <>
        <div className="offset-1 col-10 col-xxl-4 project-img" style={{ cursor: props.slides.length > 0 ? 'pointer' : 'initial' }}
             onClick={() => props.onProjectSelect ? props.onProjectSelect() : () => { return; }}>
